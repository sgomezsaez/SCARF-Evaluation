...
n, bins, patches = ax1.hist(countRequests, 50, normed=True, facecolor='blue', alpha=0.5)
...
mu, sigma = 100, 15
n, bins, patches = ax1.hist(countBytes, 50, normed=True, facecolor='blue', alpha=0.5)
bincenters = 0.5*(bins[1:]+bins[:-1])
y = mlab.normpdf( bincenters, mu, sigma)
